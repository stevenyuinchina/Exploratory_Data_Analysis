...
plot(household_power_consumption_filtered$DateAndTime,household_power_consumption_filtered$Voltage,type="l",ylab="Voltage",xlab="datetime")
plot(household_power_consumption_filtered$DateAndTime,household_power_consumption_filtered$Global_reactive_power,type='l',xlab="datetime",ylab="Global_reactive_power")
